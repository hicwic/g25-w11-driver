...
{
    public const string ServiceName = "g25vg29";
    public const string DisplayName = "G25 Virtual G29";
    ...
    public static int Install()
    {
        ...
        Sc($"description {ServiceName} \"Supervises the Virtual G29 wheel bridge. On-demand; started by G25 Control.\"");
